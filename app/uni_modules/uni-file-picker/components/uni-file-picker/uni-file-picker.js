(global.webpackJsonp = global.webpackJsonp || []).push([["uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker"], {
    "00ab": function (e, t, i) {
        (function (e, n) {
            ...
            var s = r(i("7eb4")), a = r(i("af34")), l = r(i("7ca3")), u = r(i("ee10")), o = i("5192"), c = i("2877");
            ...
            var h = {
                ...
                created: function () {
                    e.config && e.config.provider || (this.noSpace = !0, e.chooseAndUploadFile = o.chooseAndUploadFile), this.form = this.getForm("uniForms"), this.formItem = this.getForm("uniFormsItem"), this.form && this.formItem && this.formItem.name && (this.rename = this.formItem.name, this.form.inputChildrens.push(this))
                },
                methods: {
                    clearFiles: function (e) {
                        ...
                        var e = [];
                        this.files.forEach((function (t, i) {
                            ...
                            return s.default.wrap((function (t) {
                                for (; ;) switch (t.prev = t.next) {
                                            ...
                                            var e = (0, u.default)(s.default.mark((function e(t) {
                                                ...
                                                return s.default.wrap((function (e) {
                                                    for (; ;) switch (e.prev = e.next) {
                                                        case 0:
                                                            if (n = /cloud:\/\/([\w.]+\/?)\S*/, "", r = t.fileID ? t.fileID : t.url, !n.test(r)) {
                                                                e.next = 8;
                                                                break
                                                            }
                                                        ...
                                                        case 7:
                                                            t.url = e.sent;
                                                        case 8:
                                                            return t.path = t.url, e.abrupt("return", t);
                                                        case 10:
                                                        case"end":
                                                            return e.stop()
                                                    }
                                    ...
                                    case 16:
                                        ...
                                        break;
                                    case 19:
                                        i.localValue = e, i.form && i.formItem && !i.is_reset && (i.is_reset = !1, i.formItem.setValue(i.localValue)), l = Object.keys(e).length > 0 ? e : [], i.files = [].concat(l);
                                    case 23:
                                    case"end":
                                        return t.stop()
                                }
                        ...
                        return (0, u.default)(s.default.mark((function i() {
                            ...
                            return s.default.wrap((function (i) {
                                for (; ;) switch (i.prev = i.next) {
                                    case 0:
                                        n = (0, c.get_extname)(t.fileExtname), (1 === Number(t.limitLength) && t.disablePreview && !t.disabled || "object" === t.returnType) && (t.files = []), r = (0, c.get_files_and_is_max)(e, n), a = r.filePaths, l = r.files, n && n.length > 0 || (a = e.tempFilePaths, l = e.tempFiles), u = [], o = 0;
                                    case 7:
                                        if (!(o < l.length)) {
                                            i.next = 21;
                                            break
                                    ...
                                    case 10:
                                        return l[o].uuid = Date.now(), i.next = 13, (0, c.get_file_data)(l[o], t.fileMediatype);
                                    case 13:
                                        (f = i.sent).progress = 0, f.status = "ready", t.files.push(f), u.push(p(p({}, f), {}, {file: l[o]}));
                                    case 18:
                                        o++, i.next = 7;
                                        break;
                                    case 21:
                                        t.$emit("select", {
                                            tempFiles: u,
                                            tempFilePaths: a
                                        }), e.tempFiles = l, t.autoUpload && !t.noSpace || (e.tempFiles = []);
                                    case 24:
                                    case"end":
                                        return i.stop()
                                }
                        ...
                        var t = this;
                        e = [].concat(e), o.uploadCloudFiles.call(this, e, 5, (function (e) {
                            t.setProgress(e, e.index, !0)
                        })).then((function (e) {
                            t.setSuccessAndError(e)
                        })).catch((function (e) {
                            console.log(e)
                        }))
                                    ...
                                    case 0:
                                        n = [], r = [], a = [], l = [], u = s.default.mark((function t(u) {
                                            ...
                                            return s.default.wrap((function (t) {
                                                for (; ;) switch (t.prev = t.next) {
                                                    case 0:
                                                        if (o = e[u], -1 !== (c = o.uuid ? i.files.findIndex((function (e) {
                                                    ...
                                                    case 4:
                                                        ...
                                                        i.files[c].url = o.path, i.files[c].status = "error", i.files[c].errMsg = o.errMsg, r.push(i.files[c]), l.push(i.files[c].url), t.next = 26;
                                                        break;
                                                    case 12:
                                                        if (i.files[c].errMsg = "", i.files[c].fileID = o.url, !/cloud:\/\/([\w.]+\/?)\S*/.test(o.url)) {
                                                            t.next = 21;
                                                            break
                                                        }
                        ...
                        return {name: e.substring(0, t), ext: e.substring(t + 1, i)}
                    }, setEmit: function () {
                        var e = [];
                        "object" === this.returnType ? (e = this.backObject(this.files)[0], this.localValue = {}, Object.assign(this.localValue, e)) : (e = this.backObject(this.files), this.localValue || (this.localValue = []), this.localValue = (0, a.default)(e)), this.$emit("input", this.localValue)
                        ...
                        return (0, u.default)(s.default.mark((function i() {
                            ...
                            return s.default.wrap((function (i) {
                                for (; ;) switch (i.prev = i.next) {
                                    case 0:
                                        return t = {fileList: [].concat(t)}, i.next = 3, e.getTempFileURL(t);
                                    case 3:
            ...
            t.default = h
        }).call(this, i("861b").uniCloud, i("df3c").default)
    }, 5223: function (e, t, i) {
        var n = i("c6af");
        i.n(n).a
    }, b2e8: function (e, t, i) {
        i.r(t);
        var n = i("00ab"), r = i.n(n);
        ...
        i("5223");
        var a = i("828b"), l = Object(a.a)(r.default, n.b, n.c, !1, null, null, null, !1, n.a, void 0);
        t.default = l.exports
    }, c6af: function (e, t, i) {
    }, e857: function (e, t, i) {
        i.d(t, "b", (function () {
        ...
        var n = function () {
            this.$createElement;
            var e = (this._self._c, this.title ? this.filesList.length : null);
    ...
    "uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker-create-component": function (e, t, i) {
        i("df3c").createComponent(i("b5ea"))
    }
