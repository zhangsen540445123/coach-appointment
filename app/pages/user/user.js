(global.webpackJsonp = global.webpackJsonp || []).push([
  ["pages/user/user"], {
        ...
        var t = e("9359"),
          ...
          i = {
            ...
            methods: {
              toInfoList: function () {
                n.navigateTo({
                  url: "/pages/user/infoNotice"
                })
              },
              showProtocol: function (o) {
                n.navigateTo({
                  url: "/pages/consult/protocolPage?value=" + o
                })
              },
              toInfoEdit: function () {
                n.navigateTo({
              ...
              toUserFocus: function () {
                console.log("=== toUserFocus 被调用 ===");
                console.log("登录状态:", this.loginc.isLogined());
                if (this.loginc.isLogined()) {
                  console.log("准备跳转到 /pages/user/userFocus");
                  n.navigateTo({
                    url: "/pages/user/userFocus",
                    fail: function (e) {
              ...
              toPreOrderList: function () {
                n.navigateTo({
                  url: "/pages/userList/preOrderList"
                })
              },
              toAccountMassage: function () {
                n.navigateTo({
                  url: "/pages/userList/accountMassage"
                })
              },
    ...
    "2a54": function (n, o, e) {
      ...
      var t = function () {
          this.$createElement;
          var n = (this._self._c, e("42d6")),
            o = this.loginc.getInfo(),
            t = o.headUrl ? this.loginc.getInfo() : null,
            a = o.headUrl ? null : e("3d73"),
            i = this.loginc.getInfo().nickName || "微信用户",
    ...
    af9f: function (n, o, e) {
      ...
      e("fd51");
      var u = e("828b"),
        r = Object(u.a)(a.default, t.b, t.c, !1, null, "03281493", null, !1, t.a, void 0);
      o.default = r.exports
    }
  },
  [
