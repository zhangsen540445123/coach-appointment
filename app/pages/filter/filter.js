        ...
        var a = o(n("7eb4")),
          ...
          g = {
              ...
              return (0, i.default)(a.default.mark((function n() {
                return a.default.wrap((function (n) {
                  for (;;) switch (n.prev = n.next) {
                    case 0:
                      return e.filterData = u.default, e.getAddressList(), e.formData.pager.index = 1, e.bg = {
                        "近期可约": d.default,
                        "低价咨询": h.default,
                        "线下咨询": p.default,
                        "青少年父母": m.default
                      } [t.mode], e.formData.shortcut = +t.shortcut, n.next = 7, e.counselorUserList();
                    case 7:
                    case "end":
                      return n.stop()
                  }
            ...
            methods: {
              confirm: function (t) {
                var e = t.value[1][0],
                  n = t.value[0][0][0] || t.value[0][1][0] || "全部---全部",
                  o = t.value[3][2],
                  a = function (t, n) {
                    return e.includes(n) || e.includes(0) ? {
                      label: t,
                      value: n
                    } : null
                  },
                  r = [a("情绪困扰", 1), a("婚姻恋爱", 2), a("人际关系", 3), a("家庭困扰", 4), a("个人成长", 5), a("学业职场", 6), a("亲子教育", 7), a("身心健康", 8), a("性心理", 9)].filter((function (t) {
                    return !!t
                  })),
                  i = {
                    province: n.split("---")[0],
                ...
                Object.values(i).every((function (t) {
                  return "全部" === t
                })) && (i = {
                  province: null,
                  city: null,
                  area: null
                }), this.seachData.consultTypeList = o, this.seachData.serviceType = [], this.seachData.sexList = t.value[3][1], this.seachData.priceList = t.value[2][0], this.seachData.consultTimeList = t.value[3][3], this.seachData.sort = t.value[4][0][0], this.seachData.troubleList = r, this.seachData.address = i, t.value[3][0].includes(0) || 2 === t.value[3][0].length ? this.seachData.consultWay = 0 : this.seachData.consultWay = t.value[3][0][0], this.formData.filter = this.seachData, this.formData.name = null, this.formData.shortcut = null, this.resetIndex(), this.counselorUserList()
              },
