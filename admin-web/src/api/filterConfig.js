...
export const filterConfigApi = {
    ...
    createSortOption: (data) => request.post('/admin/filterConfig/sortOptions', data),
    updateSortOption: (id, data) => request.put(`/admin/filterConfig/sortOptions/${id}`, data),
    deleteSortOption: (id) => request.delete(`/admin/filterConfig/sortOptions/${id}`),
    updateSortOptionEnabled: (id, enabled) => request.put(`/admin/filterConfig/sortOptions/${id}/enabled`, { enabled })
}