...
docker build -f Dockerfile -t zhangsen0819/coach-appointment-backend:latest .
...
docker push zhangsen0819/coach-appointment-backend:latest
...
echo Coach backend packaging and push completed successfully!
