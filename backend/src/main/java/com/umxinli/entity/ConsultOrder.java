...
public class ConsultOrder extends BaseEntity {
    ...
    public ConsultOrder(Long id, String orderNo, Long userId, Long counselorId, Integer consultType, Integer consultWay, BigDecimal price, Integer status, Date paymentTime, Date consultTime) {
        this.id = id;
