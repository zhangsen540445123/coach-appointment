...
public interface OrderMapper {
    ...
    List<Order> selectListWithKeyword(@Param("offset") int offset, @Param("limit") int limit, @Param("statusList") List<Integer> statusList, @Param("keyword") String keyword);
    ...
    int countByStatusAndKeyword(@Param("statusList") List<Integer> statusList, @Param("keyword") String keyword);
